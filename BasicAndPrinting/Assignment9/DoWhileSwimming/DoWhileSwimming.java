//BasicAndPrinting DoWhileSwimming 15pts Nico Liao
//1. Yes, they both swim for the same amount of time
//2. Gallant swims for 0 min while Goofus swims for 1 min
//3. Yes, Gallant checks the temperature
//4. No, Goofus does not check the temperature
//5. A while loop will detect the condition first, and Do-while loop will run the program once, then detect the condition
//6. while loop is the pretest loop, and do-while loop is the post test
import java.util.*;
